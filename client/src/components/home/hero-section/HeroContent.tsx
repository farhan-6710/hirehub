...
const HeroContent = () => {
  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center px-4 py-12 sm:py-28 text-center sm:px-6">
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="text-3xl font-black leading-tight text-foreground sm:text-5xl lg:text-6xl tracking-tight sm:tracking-normal"
        >
