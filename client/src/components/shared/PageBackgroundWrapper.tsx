...
export function PageBackgroundWrapper({
  ...
  return (
    <div className={cn("relative isolate bg-background h-full", className)}>
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        ...
        <BlurryBlobTwo
          ...
          firstBlobColor="bg-primary-950/40 dark:bg-primary-950"
          secondBlobColor="bg-primary-900/60 dark:bg-primary-900"
        />
